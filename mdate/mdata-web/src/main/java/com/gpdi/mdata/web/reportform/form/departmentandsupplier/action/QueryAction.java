package com.gpdi.mdata.web.reportform.form.departmentandsupplier.action;
...
public class QueryAction {
    ...
    public QueryResult execute(QueryData queryData, PageSettings settings, Model model){
        List<PurchaseContract> purList = allContractDealService.getDepartNameContractType(queryData);
        model.addAttribute("vale1",purList);
        return allContractDealService.queryDepartmentAndSupplier(queryData,settings);
    }
