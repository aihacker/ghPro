    ...
    <form:form modelAttribute="queryData" method="get" >
        <div class="form-inline clearfix">
            <div class="form-group col-xs-12">
              ...
              <%--  <form:input path="contractName"  cssClass="form-control width15" placeholder="合同名称"/> +
                <form:input path="supperName"  cssClass="form-control width15" placeholder="供应商名称"/>--%>
                <button type="submit" class="btn btn-success" onclick="return check();">查询</button>
                &nbsp;
                <%--<button class="btn btn-warning">围标</button>
                &nbsp;
                <button type="reset"  class="btn btn-warning">拆单</button>
                &nbsp;
                <button type="reset"  class="btn btn-warning">倒签</button>
                &nbsp;
                <button type="reset"  class="btn btn-warning">应招未招</button>--%>
            </div>
        </div>
    </form:form>
