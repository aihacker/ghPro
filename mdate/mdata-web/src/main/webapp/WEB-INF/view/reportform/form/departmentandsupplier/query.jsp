    ...
    <div class="add-table col-xs-12>
        ...
        <table id="myTable" class="table table-bordered tablesorter" style="width: 50%;float: left">
            ...
            <c:forEach items="${queryResult.rows}" var="row" varStatus="status">
                ...
                <td><a href="${home}/reportform/form/partcontractnumber/query.html?dept=${row.undertake_dept}&&name=${row.contract_type}&&purchaseWay=${row.purchase_way}">${row.sss}</a></td>
        ...
        <table id="myTable1" class="table table-bordered tablesorter" style="width: 50%;float: left">
            ...
            <tbody>
            <c:forEach items="${vale1}" var="tp" varStatus="status">
                <tr>
                    <td>${tp.getSupplierName()}</td>
                    <td><a href="${home}/reportform/form/partcontractnumber/query.html?name=${tp.getContractTypeName()}&&supperName=${tp.getSupplierName()}&&purchaseWay=${tp.getPurchaseWay()}">${tp.getContractCode()}</a></td>
