...
<html>
    ...
    <body class="${param.edit == 1 or contractType.id == null? 'edit': 'view'}">
        <div class="">
            <div class="">
                <div class="three-nav col-xs-12">
                    <div class="row">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="javascript:location.href=document.referrer;">类型新增</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="main clearfix">
                <form:form modelAttribute="contractType" action="operate.json" method="post">
                    ...
                    <div class="clearfix mt20 form-horizontal">
                        ...
                        <div class="col-xs-12 mt10">
                            <div class="form-group">
                                <label  class="col-sm-3 control-label mg20">合同类型大类名称：</label>
                                <div class="col-sm-3">
                        ...
                        <div class="col-xs-12 mt10">
                            <div class="form-group">
                                <label  class="col-sm-3 control-label mg20">合同类型编码：</label>
                                <div class="col-sm-3">
