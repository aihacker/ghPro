...
<div class="">
    ...
    <div class="main clearfix">
        <form:form modelAttribute="userData" action="operate.json?action=save2" method="post" id="baseInfo" enctype="multipart/form-data" >
...
<script>
    $('#saveAndToJOB').click(function () {
        if(!window.confirm('确定保存吗?')){return ;}
            ...
            var params = {userId:userId , newPass :news};
            $.ajax({
                url:'operate.json?action=save2',
                data:params,
