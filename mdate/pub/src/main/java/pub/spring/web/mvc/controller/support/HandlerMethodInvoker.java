...
//        this(methodResolver, bindingInitializer, new DefaultSessionAttributeStore(), null, null, null);
        this(methodResolver, bindingInitializer, new XDataSessionAttributeStore(), null, null, null);
    }
                ...
                for (String attrName : originalAttrNames) {
                    ...
                    if (!attrName.startsWith(BindingResult.MODEL_KEY_PREFIX) &&
                        ...
                        if (mavModel != null && !model.containsKey(bindingResultKey) &&
                                //z
                                webRequest.getAttribute(bindingResultKey, RequestAttributes.SCOPE_REQUEST) == null) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            if (annotationsFound == 0) {
                ...
                if (argValue != WebArgumentResolver.UNRESOLVED) {
                    ...
                    if (paramType == pub.spring.web.mvc.model.Model.class) {
                        args[i] = implicitModel;
                    }
                    else if (Model.class.isAssignableFrom(paramType) || Map.class.isAssignableFrom
                            (paramType)) {
