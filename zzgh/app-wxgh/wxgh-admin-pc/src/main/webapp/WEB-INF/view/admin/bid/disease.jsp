        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="deviceForm">
                    ...
                    <%--<div class="form-group">--%>
                        <%--<label>性别</label>--%>
                        <%--&lt;%&ndash;<input class="form-control" type="file" name="coverFile" id="coverFile">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<img src="${home}/image/default/act.png" style="height: 200px;" name="cover">&ndash;%&gt;--%>
                        <%--<div id="sex"></div>--%>
                    <%--</div>--%>
                    <%--<div class="form-group">--%>
                        <%--<label>民族</label>--%>
...
<script>
    $(function () {
        ...
        function apply_suggest(info, $item) {
            info['action'] = 'apply'
            ui.post(__self+"deachange.json", info, function () {
