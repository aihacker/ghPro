            ...
            <div class="modal-body">
                <form id="deviceForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" readonly="readonly" class="form-control" placeholder="请选择开始时间" id="startTime"
                               name="startTime" maxlength="30">
                    </div>
                    <div class="form-group">
                        <label for="endTime">结束时间</label>
                        <input type="text" readonly="readonly" class="form-control" placeholder="请选择结束时间" id="endTime"
                               name="endTime" maxlength="30">
                    </div>
                    <div class="form-group">
                        <label>内容</label>
        ...
        $("#deviceOkBtn").click(function () {
            ...
            if($(".ui-file-item").length==2){
                upload.upload(function (fileIds) {
                    ...
                    ui.post(__self+"lessonapply.json", data, function () {
