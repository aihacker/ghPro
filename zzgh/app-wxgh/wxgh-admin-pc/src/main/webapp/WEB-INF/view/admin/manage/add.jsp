...
<style>
    ...
    .list-group-item .mui-media-object{
        float: left;
    }
</style>
<div clss="row">
    <form class="form-horizontal container-fluid" role="form">
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-5 col-sm-5 col-md-5 col-lg-5">
                <label class="col-sm-4 control-label">发起人区公司:</label>
                <div class="col-sm-8">
                    <select style="background-color: #EDEEF2;" class="form-control" name="deptid">
                        <option data-id="0">请选择区公司</option>
        ...
        <div id="allmap" style="height:250px;width:80%;margin-left:5%;display:none;">
...
<script type="text/javascript">
    $(function () {
        ...
        $('#btn-add').on('click', function () {
            var data = getInfo()
            var url = homePath + '/admin/manage/api/add_act.json'
            var startTime=$("input[name='startTime']").val()
            var endTime=$("input[name='endTime']").val()
            var start=new Date(startTime)
            var end=new Date(endTime)
            var cha=parseInt(end - start)
            if(cha<=0){
                ...
                success: function (rs) {
                    ...
                    if (data.length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            ps = ps + '<li data-userid="' + data[i].userid + '" class="list-group-item"style="background-color: white; margin-bottom: 5px;"><a><img style="width: 37px;border-radius: 50%;"class="mui-media-object"src="' + avatar + '"><div class="mui-media-body mui-ellipsis"style="margin-top: 10px;"><span class="span-username">' + data[i].name + '</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + data[i].department + ' - <span class="mobile">' + data[i].mobile + '</span></div></a></li>';
                        }
    ...
    $("#searchModal ul").on("click", "li", function () {
        ...
        if (search_input == "leader") {
            ...
            $('input[name=phone]').val($(this).find('.mobile').text());
        }
