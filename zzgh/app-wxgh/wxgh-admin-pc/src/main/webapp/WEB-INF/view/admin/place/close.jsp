...
//            }
        ...
        $("#addLawBtn").on("click", function () {
            ...
            ui.confirm("是否发送停场公告？", function () {
                ui.post("place/api/close_v2.json", info, function () {
                    ui.alert("公告发送成功", function () {
                        ui.history.go("place/close")
                    })
                })
            })
...
//            var date2 = Date.parse(new Date(info['date']))
        ...
        function list_cates(placeId) {
            ui.get('place/api/list_cate.json', {placeId: placeId}, function (cates) {
        ...
        function list_site(cateid) {
            ...
            ui.post('place/api/getplacesite.json', {placeId: placeId, cateId: cateid}, function (sites) {
