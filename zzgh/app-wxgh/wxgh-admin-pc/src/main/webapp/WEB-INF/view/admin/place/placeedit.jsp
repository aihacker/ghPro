                                    ...
                                    <tr data-id="${r.id}">
                                        ...
                                        <td class="ui-yuyue-manager-opration">
                                            ...
                                            <c:if test="${r.type eq 1}">
                                                <a href="${home}/place/admin/expection/show.html?id=${r.id}&placeId=${param.id}">查看例外</a>
                                            </c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
...
<script>
    ...
    var self_url = '${home}/admin/place/api/';
...
<script type="text/javascript" src="${home}/script/place/place_edit.js"></script>
