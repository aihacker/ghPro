        ...
        <form id="mpnewsForm" style="padding-bottom:30px;">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="select-type">
                    <option value="1" selected="selected">企业新闻</option>
                    <option value="2">重点工作通知</option>
                    <option value="3">工会活动信息</option>
                </select>
            </div>
            <div class="form-group">
                <label>封面图片</label><br/>
...
<script>
    ...
    $(function () {
       ...
       // var uploader = ui.uploader('#coverImgDiv')
        var $form = $('#mpnewsForm');//添加图文消息
        var url = homePath+'/admin/tribe/api/send_news.json';
        $('#sendBtn').click(function () {
            ...
            mpArticle['safe'] = safe
            mpArticle['send'] = send
            mpArticle['type'] = $("#select-type").val()
