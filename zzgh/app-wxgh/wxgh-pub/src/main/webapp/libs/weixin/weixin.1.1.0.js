!function (a, b) {
    ...
    var p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H= !1, I=[];
    if (!a.jWeixin)return p = {
        ...
        },getLocalImgData: function (a) {H === !1 ? (H = !0, c("getLocalImgData", {localId: a.localId}, function () {return a._complete = function (a) {if (H = !1, I.length > 0) {var b = I.shift();wx.getLocalImgData(b)}}, a}())) : I.push(a)}, getNetworkType: function (a) {
            var b = function (a) {
