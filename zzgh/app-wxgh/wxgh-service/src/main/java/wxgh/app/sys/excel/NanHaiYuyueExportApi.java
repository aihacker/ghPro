 ...
 */
@Component
public class NanHaiYuyueExportApi extends ExcelApi<NanHaiPlaceYuyue> {
    ...
    @Override
    public void createCellItem(NanHaiPlaceYuyue placeYuyue, Row row, int i) {
        if(placeYuyue == null)
            return;
