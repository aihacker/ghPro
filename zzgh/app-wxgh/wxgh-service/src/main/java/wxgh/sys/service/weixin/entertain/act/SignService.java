...
public class SignService {
    ...
    public void sign(ActSign sign) {
        ...
        String signSql = new SQL.SqlBuilder()
                ...
                .field("(select type from t_act_join where act_id = a.act_id and userid = ?) as joinType")
                .where("a.id = ?")
                .build().sql();
        ...
        if (signInfo != null) {
            ...
            pubDao.executeBean(JdbcSQL.save(ActSign.class), sign);
        }
    }
