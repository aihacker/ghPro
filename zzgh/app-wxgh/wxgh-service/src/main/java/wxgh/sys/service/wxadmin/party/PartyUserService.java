package wxgh.sys.service.wxadmin.party;
...
public class PartyUserService {
    ...
    public List<User> searchUser(String key) {
        String sql = "select u.name,u.mobile,u.deptid,u.userid,u.avatar, wd.deptname from t_user u join t_dept wd on wd.deptid = u.deptid where u.name like ? or u.mobile like ? or u.userid like ? group by u.userid limit 8";
