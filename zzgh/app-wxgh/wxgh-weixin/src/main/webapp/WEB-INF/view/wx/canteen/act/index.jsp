...
<div class="mui-content">
    <div id="segmentedControl"
        ...
        <a data-type="2" class="mui-control-item">我的订单
        </a>
    </div>
...
<div id="addActSheet" class="mui-popover mui-popover-action mui-popover-bottom">
    <ul class="mui-table-view">
        ...
        <li class="mui-table-view-cell">
            <a data-type="0" href="javascript:;" style="color: #FF3B30;">饭堂订餐</a>
        </li>
    </ul>
    <ul class="mui-table-view">
        <li class="mui-table-view-cell">
    ...
    $(function () {
        ...
        function bindfn(d) {
            ...
            $item.on('tap', function () {
                mui.openWindow(homePath + '/wx/canteen/act/show.html?id=' + d['id'])
            })
