...
<div class="mui-scroll-wrapper">
        ...
        <div class="mui-content">
            <div>
              ...
              <div class="ui-content ui-margin-top-10">
                    ...
                    <a href="${home}/wx/canteen/act/detail.html?id=${a.id}">查看详情</a>
                </div>
                <ul class="mui-table-view ui-margin-top-10 no">
                    ...
                    <c:if test="${a.hasScore eq 1}">
                        <li class="mui-table-view-cell">
                            <a href="${home}/wx/canteen/act/score.html?id=${a.id}" class="mui-navigate-right ui-flex">
                                <span>活动积分</span>
                ...
                <ul class="mui-table-view ui-margin-top-10 no">
                    ...
                    <li class="mui-table-view-cell">
                        ...
                        <a href="${home}/wx/canteen/act/join.html?id=${a.id}" class="mui-navigate-right ui-flex">
                            </c:when>
                            <c:otherwise>
                            <a href="${home}/wx/canteen/act/join.html?id=${a.id}&dateid=${a.dateid}" class="mui-navigate-right ui-flex">
                                </c:otherwise>
                                </c:choose>
                                <span>报名情况</span>
    ...
    <div id="addActSheet" class="mui-popover">
        <ul class="mui-table-view">
            <li class="mui-table-view-cell">
                <a data-url="add.html?id=${a.id}&dateid=${a.dateid}" href="javascript:;">立即签到</a>
            </li>
            <li class="mui-table-view-cell">
                <a data-url="list.html?id=${a.id}&dateid=${a.dateid}" href="javascript:;"
