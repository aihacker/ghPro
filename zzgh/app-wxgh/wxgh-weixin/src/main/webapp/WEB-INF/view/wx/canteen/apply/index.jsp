        ...
        $(function () {
            ...
            function bindfn(d) {
                ...
                $item.on('tap', '.ui-apply-btn', function () {
                    var $self = $(this)
                    console.log(d)
                    mui.confirm('同意他加入饭堂吗？', '同意确认', ['不同意', '同意'], function (e) {
                        if (e.index == 1) {
                            apply_request(1, d.id, $self)
                            window.location.reload(true);
                        } else {
                            mui.confirm('你将拒绝他的申请', '拒绝确认', ['否', '是'], function (e) {
                                if (e.index == 1) {
            ...
            function apply_request(status, id, $btn) {
                loading.show()
                wxgh.request.post('/wx/canteen/apply/apply.json', {
                    status: status,
                    id: id,
                    groupId: groupId
                }, function () {
