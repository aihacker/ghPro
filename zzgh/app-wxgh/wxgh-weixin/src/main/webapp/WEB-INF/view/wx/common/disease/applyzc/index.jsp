    ...
    <form id="applyForm">
        <div class="mui-input-group ui-margin-top-10">
            ...
            <div class="textare-div">
                <label>情况介绍</label>
                <textarea name="info" rows="4" placeholder="简单介绍事故发生情况"></textarea>
            </div>
        </div>
        <div class="mui-input-group ui-margin-top-15">
            <div class="mui-input-row">
                <label>认证机构</label>
                <input name="dentification" type="text" class="mui-input-clear" placeholder="工伤认证机构">
            </div>
            <div class="select-image-div">
                <label>附件上传</label>

                <div class="img-item">
                    <input id="applyFileInput" name="files[]" type="file" multiple="multiple" accept="image/*">
...
<script type="text/javascript">
    ...
    var form = {
        ...
        request: function (info) {
            ...
            var url = homePath + "/wx/common/disease/applyzc/add.json";
            $.ajaxFileUpload({
                url: url,
                data: info,
                secureuri: false,
