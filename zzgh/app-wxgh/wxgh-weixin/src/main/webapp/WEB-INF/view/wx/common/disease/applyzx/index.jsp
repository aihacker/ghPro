...
<%--<header class="mui-bar mui-bar-nav ui-head">--%>
    ...
    <%--<h1 class="mui-title">直系亲属去世资助申请</h1>--%>
...
<div class="mui-content">
    <form id="applyForm">
        <div class="mui-input-group ui-margin-top-10">
            ...
            <div class="mui-input-row">
                <label>姓&nbsp;&nbsp;&nbsp;&nbsp;名</label>
                <input name="name" type="text" class="mui-input-clear" placeholder="亲属的姓名">
            </div>
        ...
        <div class="mui-input-group ui-margin-top-15">
            <div class="select-image-div">
                ...
                <div class="img-item">
                    <input name="files[]" id="applyFileInput" type="file" multiple="multiple" accept="image/*">
...
<script type="text/javascript">
    ...
    var form = {
        ...
        request: function (info) {
            ...
            var url = homePath + "/wx/common/disease/applyzx/add.json";
            $.ajaxFileUpload({
                url: url,
                data: info,
                secureuri: false,
