...
<script type="text/javascript">
    ...
    var addOption = {
        ...
        createItem: function (num) {
            ...
            //  e_div.innerHTML = '<label>选项</label><input type="text" placeholder="' + num + '"><span class="mui-icon mui-icon-close ui-text-secondary ui-vote-option-close mui-hidden"></span>';
            return e_div;
        },
        ...
        verify: function () {
            ...
            for (var i = 0; i < options.length; i++) {
                if (options[i].trim().length <= 0) {
                    return "选项" + (i + 1) + "内容不能为空哦"
                }
            }
        },
        //请求服务器
        request: function () {
            var url = homePath + "/wx/common/vote/add/add.json";
            var info = {
//                action: "add",
                theme: voteTheme.val,
                userid: userId,
