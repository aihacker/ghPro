...
<div class="ui-fixed-btn right">
    <a href="${home}/wx/common/vote/add/index.html"><span class="fa fa-plus"
...
<script type="text/javascript">
    ...
    var page = {
        ...
        __createItem: function (v) {
            ...
            chevronLi.appendChild(this.__create_option(v))
        ...
        __create_option: function (v) {
            var e_ul = document.createElement("ul")
            e_ul.className = 'mui-table-view mui-table-view-chevron'

            var options = v.voteOptions
            for (var i = 0; i < options.length; i++) {
                var o = options[i]
                var e_li = document.createElement("li")
                e_li.className = 'mui-table-view-cell mui-radio mui-left'
                e_li.innerHTML = '<input value="' + o.id + '" type="checkbox" name="vote' + v.id + '"/>' +
                    '<span class="mui-badge mui-badge-success">' + o.ticketNum + ' 票</span>' + o.options
...
//                action: 'vote',
    ...
    var refresh = refresh('#refreshContainer', {
        url: homePath + '/wx/common/vote/list.json',
//        data: {action: 'list'},
        dataEl: '.vote-list',
        ispage: true,
        bindFn: bindfn,
