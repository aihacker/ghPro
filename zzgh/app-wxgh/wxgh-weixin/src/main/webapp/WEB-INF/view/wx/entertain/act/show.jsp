            ...
            <div>
                ...
                <ul class="mui-table-view ui-margin-top-10 no">
                    ...
                    <li class="mui-table-view-cell">
                        ...
                        <a href="show/join.html?id=${a.id}" class="mui-navigate-right ui-flex">
                            </c:when>
                            <c:otherwise>
                            <a href="show/join.html?id=${a.id}&dateid=${a.dateid}" class="mui-navigate-right ui-flex">
                                </c:otherwise>
                                </c:choose>
                                <span>报名情况</span>
...
//            wxgh.wxShareInit($('#actName').text(), window.location.href, imgSrc, $('#actInfo').attr('title'))
            ...
            $('.ui-fixed-bottom').on('tap', 'button[data-type]', function () {
                ...
                ui.confirm('是否' + typeName, function () {
                    loading.show()
                    wxgh.request.post(homePath + '/wx/entertain/act/show/act_join.json', {
                        id: actId,
                        type: type
                    }, function () {
