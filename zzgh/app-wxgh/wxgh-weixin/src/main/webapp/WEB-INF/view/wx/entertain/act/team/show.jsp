    ...
    <div class="mui-scroll">
        <div class="mui-content">
            ...
            <div class="ui-content ui-margin-top-10">
                ...
                <a href="${home}/wx/entertain/act/show/detail.html?id=${a.id}">查看详情</a>
            </div>
...
//        var imgSrc = $('.bg-img img').attr('src')
        ...
        $('.ui-fixed-bottom').on('tap', 'button[data-type]', function () {
            ...
            ui.confirm('是否' + typeName, function () {
                loading.show()
                wxgh.request.post('${home}/wx/entertain/act/show/act_join_by_team.json', {id: actId, type: type}, function () {
