...
<header class="mui-bar mui-bar-nav ui-head">
    ...
    <%--<div id="headSegmented" class="mui-segmented-control mui-segmented-control-inverted">--%>
    ...
    <%--<a id="searchInput" class="mui-icon mui-icon-search"></a>--%>
</header>
...
<script type="text/javascript">
    ...
    var page = {
        ...
        request: function (typeInt, placeType) {
            ...
            var url = homePath + '/wx/entertain/place/place_list.json';
            var info = {
                typeInt: typeInt,
                placeType: placeType
            };
        ...
        init_ad: function (p) {
            if (p) {
                ...
                self.querySelector('a').href = homePath + '/wx/entertain/place/show.html?id=' + p.id;
        ...
        create_item: function (p) {
            ...
            e_a.href = homePath + '/wx/entertain/place/show.html?id=' + p.id;
