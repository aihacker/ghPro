...
<div class="mui-content">
    ...
    <div class="ui-fixed-bottom">
        <button data-loading-text="发布中..." id="addBtn" type="button"
                class="mui-btn mui-btn-primary ui-btn mui-btn-block">立即发布
        </button>
    </div>
</div>
...
<script type="text/javascript">
    var _self = homePath + '/wx/party/beauty/add.json'
    $(function () {
        ...
        uploader.on('uploadSuccess', function (file) {
            ...
            if (numbs.uploadFailNum <= 0 && numbs.progressNum <= 0 && numbs.queueNum <= 0 && numbs.interruptNum <= 0) {
                mui.getJSON(_self, {action: 'success', id: workId}, function (res) {
                    if (res.ok) {
                        workId = 0
                        loading.hide()
