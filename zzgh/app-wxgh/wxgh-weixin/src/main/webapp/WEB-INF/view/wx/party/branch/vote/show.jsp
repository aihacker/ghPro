    ...
    wxgh.request.get("api/get_question.json",{examid:examId},function (data) {
        for(var i = 0;i<data.length;i++) {
            ...
            if(d.type==1){
                ...
                var answer = $("<div class='mui-input-row mui-checkbox'>" +
                        "<textarea name='answerText' id='answerText_" + d.id + "' class='form-control' rows='3' maxlength='200'></textarea></div>");
                $form.append(answer)
            }
    ...
    function typeRadio(data) {
        ...
        for(var i = 0;i<data.length;i++){
            ...
            if(d.type == 1 || d.type == 2) {
                ...
                debugger
                answer.answerText = $("#answerText_"+d.id).val().trim()
            }
            info.push(answer)
        }
