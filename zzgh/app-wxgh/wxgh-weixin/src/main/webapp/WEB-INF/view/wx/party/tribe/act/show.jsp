        ...
        <div class="comm-body">
            ...
            <ul class="mui-table-view mui-grid-view">
                ...
                <li class="mui-table-view-cell mui-media mui-col-xs-6">
                    <a href="javascript:;">
                        <img class="mui-media-object" src="{{=it.imgs[i]}}">
                    </a>
                </li>
                {{}}}
            </ul>
...
<script>
    ...
    $(function () {
        ...
        $('#joinBtn').on('tap', function () {
            ...
            if (status == 0) {
                ui.confirm('是否报名？', function () {
                    wxgh.request.post('../api/join.json', {actId: actId}, function () {
                        ui.alert('报名成功，活动结算您将获得50积分', function () {
        ...
        function list_comm() {
            wxgh.request.post('../api/comm_list.json', {id: actId}, function (comms) {
                $commList.empty()
