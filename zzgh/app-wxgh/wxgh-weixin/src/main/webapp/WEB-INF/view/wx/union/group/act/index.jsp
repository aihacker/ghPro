...
<div class="mui-content">
    <div id="segmentedControl"
        ...
        <a data-type="0" class="mui-control-item mui-active">协会活动
        </a>
    ...
    $(function () {
        ...
        function bindfn(d) {
            ...
            $item.on('tap', function () {
                mui.openWindow(homePath + '/wx/entertain/act/show.html?id=' + d['id'])
            })
        ...
        $('#addActSheet').on('tap', 'a[data-type]', function () {
            var type = $(this).data('type')
            mui.openWindow(homePath + '/wx/entertain/act/group/index.html?id=' + groupId + '&type=' + type)
        })
    })
</script>
</body>
