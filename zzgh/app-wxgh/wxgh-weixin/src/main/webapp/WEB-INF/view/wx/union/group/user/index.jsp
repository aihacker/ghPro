...
<div class="mui-content">
    <div class="ui-search">
        <div class="mui-input-row mui-search">
            <input id="searchInput" type="search" class="mui-input-clear" placeholder="搜索协会成员">
        </div>
    </div>
...
<script type="text/template" id="itemTpl">
    <li class="mui-table-view-cell">
        <div class="mui-slider-right mui-disabled">
            {{?(${userType} < 4 && ${userType} < it.type && it.userid != '${wxgh_user.userid}')}}
        ...
        <div class="mui-slider-handle"><img class="mui-media-object mui-pull-left"
            ...
            <div class="mui-media-body"><p class="mui-ellipsis">{{=it.typeName}}<span
...
<script>
    ...
    $(function () {
        ...
        function bindfn(d) {
            ...
            $item.on('tap', '.del', function () {
                ui.confirm('是否删除？', function () {
                    wxgh.request.post('delete.json', {id: d.id}, function () {
