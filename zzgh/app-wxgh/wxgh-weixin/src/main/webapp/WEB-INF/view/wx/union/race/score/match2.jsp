...
<head>
    ...
    <style>
        ...
        .weui_dialog_bd .mui-table-view-radio .mui-table-view-cell {
            padding-right: 0;
        }

        .weui_dialog_bd .mui-table-view-radio .mui-table-view-cell > a:not(.mui-btn) {
            margin-right: 0;
        }
...
<div class="mui-content">
    ...
    <div id="lunNumbDiv" class="mui-content-padded mui-text-center">
        <select style="margin-bottom: 0;width: 80px;">
...
<!-- 选择用户 -->
<div class="weui_dialog_confirm" id="chooseUserConfirm" style="display: none;">
    <div class="weui_mask"></div>
    <div class="weui_dialog">
        <div class="weui_dialog_hd"><strong class="weui_dialog_title">选择用户</strong></div>
...
<script src="${home}/weixin/script/union/race/match2.js"></script>
</body>
