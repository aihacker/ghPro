...
public class ActionResult implements Serializable, ModelResult {
    ...
    public static ActionResult okAdmin(Object data, Page page) {
        RefData refData = new RefData();
        refData.put("datas", data);
        if (page != null) {
            refData.put("page", new PageBen(page));
        }
        return ActionResult.okWithData(refData);
    }

    public static ActionResult okRefresh(Object data, Page page) {
        RefData refData = new RefData();
        refData.put("datas", data);
        refData.put("total", page.getPages());
        refData.put("current", page.getCurrentPage());
        return ok(null, refData);
    }
